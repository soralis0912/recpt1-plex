...
typedef struct {
	...
	boolean IsPX4PX5PX6DeviceFlag;   // variable                                                               // Jacky Han Added
...
boolean get_px4px5px6_statistics(int fd, int type, boolean use_bell, int ch_name_index);                      // Jacky Han Added
